...
namespace DatabaseBroker.Migrations
{
    ...
    [Migration("20240824201238_language_id_null")]
    partial class language_id_null
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Models.Words.Group", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("groups", "words");
                });

            modelBuilder.Entity("Entity.Models.Words.Language", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("languages", "words");
                });

            modelBuilder.Entity("Entity.Models.Words.Word", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Entity.Models.Auth.User", b =>
                {
                    b.HasOne("Entity.Models.Words.Language", "NativeLanguage")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity.Models.Words.Group", b =>
                {
                    b.HasOne("Entity.Models.Words.Language", "FromLanguage")
                        .WithMany()
                        .HasForeignKey("FromLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Models.Words.Language", "ToLanguage")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity.Models.Words.Word", b =>
                {
                    b.HasOne("Entity.Models.Words.Group", "Group")
                        .WithMany("Words")
